  ...
  const fetchSection = async () => {
    try {
      ...
      const savedTarget = localStorage.getItem(
        `waterTarget_${farmId}_${sectionNumber}`
      );
      if (savedTarget) {
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col items-start">
            ...
            <p className="text-sm text-muted-foreground">
              {section?.crop || "Unknown Crop"} • Planted{" "}
              {section?.plantingDate || "Unknown Date"}
            </p>
          </div>
        </div>
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                <span className="text-lg font-semibold dark:text-gray-900">
                  Soil Moisture
                </span>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              <Gauge className="h-5 w-5" />
              Moisture Readings | 
              <div className="text-center mb-0 text-sm">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex justify-between items-center p-3 bg-muted rounded-lg">
                  ...
                  {editingTarget ? (
                    <span className="inline-flex items-center gap-2">
                      <Input
                        ...
                        onChange={(e) =>
                          setWaterUsageTarget(Number(e.target.value))
                        }
              ...
              <div className="text-right">
                ...
                <div
                  className={`text-sm ${
                    getTodayWaterUsage() > waterUsageTarget
                      ? "text-red-600"
                      : "text-green-600"
                  }`}
                >
